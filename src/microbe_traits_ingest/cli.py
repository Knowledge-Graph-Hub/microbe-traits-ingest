...
def download(force: bool = typer.Option(False, help="Force download of data, even if it exists")):
    """Download data for microbe-traits-ingest."""
    typer.echo("Downloading data for microbe-traits-ingest...")
...
def transform(
    ...
    """Run the Koza transform for microbe-traits-ingest."""
    typer.echo("Transforming data for microbe-traits-ingest...")
